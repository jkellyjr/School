...
public class P3A3_KELLY_3938535
{
        public static class Body
       {
        ...
        public static int numberOfVowlesInString(String s)
        {
        	int count = 0;
        ...
        public static void playGame() throws FileNotFoundException
        {
            ...
            System.out.println("Your word has " + numberOfVowlesInString(word) + " vowels!");
            ...
            {
                    System.out.println("I'm sorry but you lost. The word was: " + word);
